...
const Projects = () => {
  ...
  const chipStyle = (chipType) => {
    ...
    const inactiveStyle = "text-white/40 border-[1px] border-gray-800 bg-gray-900/40 hover:bg-gray-800 hover:text-white";
  ...
  return (
    <Container className="py-20 flex flex-col justify-center items-center gap-16">
      <div className="flex flex-col justify-center items-center gap-6">
        ...
        <div className={chipStyle('uiux')} onClick={() => setActive('uiux')} >
            UI/UX
          </div>
          <div className={chipStyle('programmer')} onClick={() => setActive('programmer')} >
            Programmer
          </div>
        </div>
      </div>
