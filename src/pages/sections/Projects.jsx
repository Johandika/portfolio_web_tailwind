  ...
  return (
    <Container className="py-20 flex flex-col justify-center items-center gap-16">
      ...
      {projects.slice(0, displayData).map((project)=> (
        <ProjectCard key={project.id} tipe={project.tipe} client={project.client} summary={project.summary} image={project.image} colorButton={project.color} 
        {...{
      ...
      <Button text={'Show More'} onClick={loadMore} outline/>
    </Container>
  );
};
